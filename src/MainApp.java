...
public class MainApp {
	...
	public static void Exercise5Test() {
		...
		// we ask the user to enter the size of an array and the length of the passwords that we will store
	    ...
	    int result = JOptionPane.showConfirmDialog(null, myPanel, 
	            "Please Enter Size and Length Values", JOptionPane.OK_CANCEL_OPTION);
